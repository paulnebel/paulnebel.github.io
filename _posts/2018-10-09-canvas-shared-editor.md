...
| ![TogetherJS - Starting a session]({{ site.url }}/assets/images/canvas-shared-editor/TogetherJS-start-session.png) |
|:--:|
...
| ![TogetherJS - Inviting participants]({{ site.url }}/assets/images/canvas-shared-editor/TogetherJS-invite-collaborator.png) |
|:--:|
...
| ![TogetherJS - Sharing a session]({{ site.url }}/assets/images/canvas-shared-editor/TogetherJS-shared-session.png) |
|:--:|
...
| ![TogetherJS - User settings]({{ site.url }}/assets/images/canvas-shared-editor/TogetherJS-user-settings.png) |
|:--:|
